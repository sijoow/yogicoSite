            ...
            <div class="section_01_inner">
                <div class="section_01_inner"  style={{padding:'0'}}>
                    <div class="seciton_lifestyle">
                        ...
                        요기코퍼레이션은 어제보다 더 멋진 오늘이 되길 바라고, 오늘보다 더
                        희망적인 내일을 기대하는 마음으로 우리 일상에 필요한 라이프 스타일
                        브랜드를 개발하고 만듭니다.<br/>
                        단순히 하나의 제품을 만드는 것에 만족하지 않고 명확한 정체성, 스타일,
                        성격, 가치관 철학을 성립하는 과정을 통해 더 많은 사람들의 삶의 가치를
                        높이는 것을 추구합니다.
                        </div>
                    </div>
                </div>
                ...
                <div class="welfare">
                    <div class="welfare_wrapper">
                        <ul>
                            <li>
                                <dl>
                                    ...
                                    <dd>
                                        <ul>
                                            <li>본사(유연근무제 적용) <br/><span>출근 09:00~10:00 | 퇴근 18:00~19:00</span></li>
                        ...
                        <ul>
                            ...
                            <li class="secont_w">
                                <dl>
                                    ...
                                    <dd>
                                        <ul>
                                            <li><span class="no_span">3개월 수습 종료 후, 폼나는 요기코만의 힐링템 지급!</span></li>
                                        </ul>
                                    </dd>
                                </dl>
                            </li>
                        ...
                        <ul>
                            <li>
                                <dl>
                                    <dt><img src="https://yogibo.kr/yogico/img/partners/cafe_icons.png"/>&nbsp;카페테리아 운영</dt>
                                    <dd>
                                        <ul>
                                            <li><span class="no_span">회사 안의 작은 캔틴에서 커피와 차 무한 리필~♥ </span></li>
                                        </ul>
                                    </dd>
                                </dl>
                            </li>
                        ...
                        <ul>
                            ...
                            <li class="secont_w">
                                <dl>
                                    <dt><img src="https://yogibo.kr/yogico/img/partners/장기근속.png"/>&nbsp;장기 근속 포상</dt>
                                    <dd>
                                        <ul>
                                            <li><span class="no_span">
                                            요기코와 함께 성장한 요미에게 감사한 마음을 가득 담아<br/> 특별한 선물을!</span></li>
                                        </ul>
                                    </dd>
                                </dl>
                            </li>
